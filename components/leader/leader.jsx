...
export default function Leader() {
  const text = `I have been a development team lead for more them 5 years now.
  I do not reallyy want to appear to show off, 
  but I have always been the one to set the tone, and others have liked to cosider me as a leader in some way since I can remember 
  (from the primary school on). I am kind of a "natural born leader" 

  Currently I am a Team Lead to a team of Teast Automation Framework engineers, establishing code standards, performing code reviews, coding, 
  ...
  Leaing development efforts in agile/scrum environment with CI/CD automation mindset and DevOps culture, 
  organizing and distributing tasks and workloads considering and planning with the current resources. 
  As part of the Leader position I am attending technical interviews helping to recruit many of the engineers on the team, organizing trainings,
  ...
  having a clear goal, a sense of progression and achievement and purpose in a production that really matters.
  ...
  I also studied psychology, pedagogy and didactics at college for 4 years wihich really helps me in working with individuals and teams 
